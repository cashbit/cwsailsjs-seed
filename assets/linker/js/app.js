...
function cometMessageReceivedFromServer(message) {
  ...
  function displayWarning(message) {
    $('#chatAudio')[0].play();
    $(".navbar").after("<div class='alert alert-success'>" + message.data.message + "</div>");
    $(".alert").fadeOut(5000);
  }
...
function displayFlashActivity(message) {
  $('#chatAudio')[0].play();
  $(".navbar").after("<div class='container alertcontainer'><div class='alert alert-success'>" + message.data.name + message.data.action + "</div></div>");
